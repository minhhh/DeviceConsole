...
//        public delegate void DebugCommand (params string[] arguments);
        ...
        public bool ExecuteCommand (string[] args)
        {
            ...
            for (int i = 0; i < commands.Count; i++) {
                if (cmdName == commands [i].name) {
                    ...
                    commands [i].method.Invoke (null, cmdArgs.ToArray ());
        ...
        /// </summary>
        public void AddCommand (string cmdName, MethodInfo method, string desc = "", string argDesc = "")
        {
            cmdName = cmdName.ToLower ();
